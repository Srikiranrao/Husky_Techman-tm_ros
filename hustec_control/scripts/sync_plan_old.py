...
class MoveItPlanningDemo:
    def __init__(self):
        ...
        self.arm = moveit_commander.MoveGroupCommander("actmove")
    ...
    def moving(self):
        ...
        # 控制机械臂先回到初始化位置
        #self.arm.set_named_target("acthome")
        #self.arm.go()
        #rospy.sleep(2)
        ...
        target_pose.pose.position.y = -0.072
        target_pose.pose.position.z = 0.067
